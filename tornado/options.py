...
class OptionParser(object):
    ...
    def __iter__(self):
        return (opt.name for opt in list(self._options.values()))
    ...
    def items(self):
        ...
        .. versionadded:: 3.1
        """
        return [(opt.name, opt.value()) for name, opt in list(self._options.items())]
    ...
    def group_dict(self, group):
        ...
        """
        return dict(
            (opt.name, opt.value()) for name, opt in list(self._options.items())
